...
if __name__ == '__main__':
    batch_size = 16
    first_iter = 250000 # 注：在batch_size = 16下，一个epoch约等于3000个iteration
    print_iter = 1000
    save_iter = 5000
    max_iter = 50000
    lr = 0.00002 # CNN_dropout 前20万个iteration：0.002,从20万开始降低10倍为0.0002，25万开始降为0.00002
    lr_beta = 1 # lr 衰减策略
    # L2 = 0.005 # L2正则化,用于应对CFAR-100这种逆天过拟合数据集, CNN.py 0.001 -> 0.41
    # L2 = 0
    L2 = 0.0001 # 前20万采用0.00001， 之后扩大十倍 -》 0.0001
