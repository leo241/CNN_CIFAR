...
if __name__ == '__main__':
    ...
    first_iter = 350000 # 注：在batch_size = 16下，一个epoch约等于3000个iteration
    print_iter = 100 # 打印频次缩小10倍
    save_iter = 2000 # 保存频次缩小10倍
    max_iter = 110000 # 只看5000 iter
    Epoch = 20000
    lr = 0.00001 # CNN_dropout 前20万个iteration：0.002
    # ,从20万开始降低10倍为0.0002
